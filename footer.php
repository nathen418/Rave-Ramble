...
<footer class="text-center text-lg-start">
  <div class="text-center p-2 footer-color">
    <a class="small text-muted">© 2023 Rave Ramble</a> | 
    ...
    <a class="small text-muted" href="https://github.com/nathen418/Rave-Ramble">Github</a> | 
