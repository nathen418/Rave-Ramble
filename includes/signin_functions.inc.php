<?php # Script 12.2 - signin_functions.inc.php
// This page defines two functions used by the signin/logout process.
 ...
 */
function check_signin($dbc, $email = '', $pass = '') {
